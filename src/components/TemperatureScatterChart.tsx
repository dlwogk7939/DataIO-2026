...
import { tempVsElectricity } from "@/data/mockData";
  ...
  <div className="rounded-lg border border-border bg-card p-5 animate-fade-in" style={{ animationDelay: "600ms" }}>
    <div className="mb-4">
      ...
      <p className="text-xs text-muted-foreground mt-1">
        Weak correlation (r=0.34) — internal loads dominate over weather sensitivity
      </p>
    </div>
    <div className="h-[280px]">
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
          ...
          />
          <Scatter data={tempVsElectricity} fill="hsl(38, 92%, 60%)" fillOpacity={0.8} />
        </ScatterChart>
      </ResponsiveContainer>
    </div>
  </div>
